...
STRINGS = {
    ...
    "f.qwen.workspace_id": {"ko": "Qwen 워크스페이스 ID (선택)",
                            "en": "Qwen workspace ID (optional)",
                            "ja": "QwenワークスペースID (任意)",
                            "zh": "Qwen 工作空间 ID（可选）"},
    "f.qwen.voice": {"ko": "Qwen 음성 (default)", "en": "Qwen voice (default)",
                     "ja": "Qwenボイス (default)", "zh": "Qwen 语音 (default)"},
