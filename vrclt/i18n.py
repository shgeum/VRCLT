...
STRINGS = {
    ...
    "vr_nav_live": {"ko": "대화", "en": "Live", "ja": "会話", "zh": "对话"},
    "vr_mode_voice": {"ko": "음성", "en": "Voice", "ja": "音声", "zh": "语音"},
    "vr_mode_text": {"ko": "텍스트", "en": "Text", "ja": "テキスト", "zh": "文字"},
    "vr_restart": {"ko": "재시작", "en": "Restart", "ja": "再起動", "zh": "重启"},
    "vr_translate": {"ko": "번역", "en": "Translate", "ja": "翻訳", "zh": "翻译"},
    "vr_subtitles": {"ko": "자막", "en": "Subtitles", "ja": "字幕", "zh": "字幕"},
    "vr_nav_audio": {"ko": "오디오", "en": "Audio", "ja": "音声", "zh": "音频"},
    "vr_nav_layout": {"ko": "위치 · 앱", "en": "Layout & app", "ja": "配置・アプリ", "zh": "位置与应用"},
    "vr_nav_settings": {"ko": "설정", "en": "Settings", "ja": "設定", "zh": "设置"},
    "vr_speaker_context_on": {"ko": "화자 유지 ON", "en": "Speaker context ON",
        "ja": "話者維持 ON", "zh": "保留说话人 ON"},
    "vr_speaker_context_off": {"ko": "화자 유지 OFF", "en": "Speaker context OFF",
        "ja": "話者維持 OFF", "zh": "保留说话人 OFF"},
    "vr_move_wrist": {"ko": "손목 UI 이동", "en": "Move wrist UI", "ja": "手首UIを移動", "zh": "移动手腕界面"},
    "vr_move_subtitles": {"ko": "자막 이동", "en": "Move subtitles", "ja": "字幕を移動", "zh": "移动字幕"},
    "vr_auto_language": {"ko": "자동 감지", "en": "Auto-detect", "ja": "自動検出", "zh": "自动识别"},
    "vr_section_position": {"ko": "화면 위치", "en": "Panel positions", "ja": "パネル位置", "zh": "面板位置"},
    "vr_section_subtitles": {"ko": "자막 표시", "en": "Subtitle display", "ja": "字幕表示", "zh": "字幕显示"},
    "vr_section_app": {"ko": "앱 설정", "en": "App settings", "ja": "アプリ設定", "zh": "应用设置"},
    "vr_reset_positions": {"ko": "자막 · 손목 위치 초기화", "en": "Reset subtitle & wrist positions",
        "ja": "字幕・手首位置をリセット", "zh": "重置字幕与手腕位置"},
    "vr_hint_languages": {"ko": "언어 이름을 누르면 목록에서 선택할 수 있습니다.",
        "en": "Tap a language name to choose from the list.", "ja": "言語名を押すと一覧から選択できます。", "zh": "点击语言名称可从列表中选择。"},
    "vr_hint_audio_apply": {"ko": "장치 선택을 마치면 잠시 후 저장하고 다시 연결합니다.",
        "en": "Device selections save and reconnect after a short pause.",
        "ja": "デバイス選択後、少し待つと保存して再接続します。", "zh": "设备选择完成后稍等片刻，即会保存并重新连接。"},
    "vr_hint_position": {"ko": "이동을 켠 뒤 패널을 잡아 위치를 조절하세요.",
        "en": "Enable moving, then grab the panel to adjust its position.",
        "ja": "移動を有効にしてパネルをつかみ、位置を調整します。", "zh": "开启移动后，抓住面板调整位置。"},
